          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
            ...
            <div className="text-center sm:text-left">
              ...
              <ul className="mt-8 space-y-4 text-sm">
                <li>
                  <a
                    className="flex items-center gap-1.5 sm:justify-start justify-center"
                    href="/"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-5 w-5 shrink-0 inline-block"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="white"
                      strokeWidth="2"
                    ...
                    <span className=" text-white transition-all hover:text-blue-500 inline-block">
