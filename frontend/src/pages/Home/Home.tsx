      ...
      <main>
        ...
        >
          ...
          <blockquote className="testimonial-grid px-5 py-4 bg-gray-100 border-l-4 border-gray-600 mb-5 text-gray-800">
            "Codefolio made building my portfolio a breeze. It truly represents
            my skills and work." - Jane Doe
          </blockquote>
          <img
          ...
          />
          <blockquote className="testimonial-grid px-5 py-4 bg-gray-100 border-l-4 border-gray-600 mb-5 text-gray-800">
            "With Codefolio, I was able to create a professional portfolio in no
            time." - John Smith
          </blockquote>
        </animated.section>
        <animated.section
        ...
        >
          <h2 className="text-4xl font-bold mb-5">
            Codefolio{" "}
            <span className="px-1 bg-indigo-500 text-white">Features</span>
          </h2>
