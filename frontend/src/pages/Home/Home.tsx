        ...
        <div className="home-container">
            <main>
                <animated.section ref={refIntro} style={fadeInIntro} className="intro-section">
                    ...
                    <img className="intro-image" src={profileDisplayImg} alt="Introductory visual"/>
                ...
                <animated.section ref={refTestimonial} style={fadeInTestimonial} className="testimonial-section">
                    ...
                    <div className="testimonial-grid">
                        ...
                        <img className={'profile-img'} src={user2PfpImg} alt="User testimonial"/>
                        <img className={'profile-img'} src={userPfpImg} alt="User testimonial"/>
