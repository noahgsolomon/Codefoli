...
const Login: React.FC = () => {
  ...
  return (
    <div className="absolute top-1/2 left-1/2 -translate-x-2/4 -translate-y-2/4 transition-all w-[700px] max-w-[80%] p-10 rounded-xl border-2 border-black shadow-[3px_3px_#0b0b0b] hover:shadow-[5px_5px_#0b0b0b] text-center bg-neutral-100">
      ...
      {showFields ? (
        ...
        <>
          <div className="flex flex-col items-center mt-5">
            <button
              className="flex items-center justify-center cursor-pointer w-full mb-3 rounded-2xl px-9 py-6 text-lg transition-all hover:opacity-90 text-white bg-[#0b0b0b] hover:-translate-y-1"
              onClick={() => {
            ...
            <button
              className="flex items-center justify-center cursor-pointer w-full mb-3 rounded-2xl px-9 py-6 text-lg transition-all hover:opacity-90 border-2 border-[#0b0b0b] text-gray-800 hover:-translate-y-1"
