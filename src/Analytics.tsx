        ...
        {loading ? (
          ...
          <>
            ...
            <div className={"mx-10 mb-48 flex flex-wrap justify-center gap-10"}>
              <div
                className={
                  "rounded-xl border-2 border-blue-500 bg-blue-50 px-6 py-6 shadow-custom transition-all hover:shadow-customHover"
                }
              >
                <h2 className={"text-2xl font-bold"}>
                  👥 <span className={"text-blue-500 underline"}>Total</span> #
                  of users:
                </h2>
                <p
                  className={
                    "mt-4 text-center text-3xl font-bold text-blue-500"
                  }
                >
                  {userCount}
                </p>
              ...
              <div
                className={
                  "rounded-xl border-2 border-yellow-500 bg-yellow-50 px-6 py-6 shadow-custom transition-all hover:shadow-customHover"
                }
              >
                <h2 className={"text-2xl font-bold"}>
                  🗓 Users registered{" "}
                  <span className={"text-yellow-500 underline"}>today</span>:
                </h2>
                <p
                  className={
                    "mt-4 text-center text-3xl font-bold text-yellow-500"
                  }
                >
                  {registers}
                </p>
              ...
              <div
                className={
                  "rounded-xl border-2 border-green-500 bg-green-50 px-6 py-6 shadow-custom transition-all hover:shadow-customHover"
                }
              >
                <h2 className={"text-2xl font-bold"}>🚀 Deployments today:</h2>
                <p
                  className={
                    "mt-4 text-center text-3xl font-bold text-green-500"
                  }
                >
                  {deployments}
                </p>
              ...
              <div
                className={
                  "rounded-xl border-2 border-purple-500 bg-purple-50 px-6 py-6 shadow-custom transition-all hover:shadow-customHover"
                }
              >
                <h2 className={"text-2xl font-bold"}>📥 Downloads today:</h2>
                <p
                  className={
                    "mt-4 text-center text-3xl font-bold text-purple-500"
                  }
                >
                  {downloads}
                </p>
              ...
              <div
                className={
                  "rounded-xl border-2 border-red-500 bg-red-50 px-6 py-6 shadow-custom transition-all hover:shadow-customHover"
                }
              >
                <h2 className={"text-2xl font-bold"}>📈 Daily active users:</h2>
                <p
                  className={"mt-4 text-center text-3xl font-bold text-red-500"}
                >
                  {dailyActiveUsers}
                </p>
              </div>
              <div
                className={
                  "rounded-xl border-2 border-orange-500 bg-orange-50 px-6 py-6 shadow-custom transition-all hover:shadow-customHover"
                }
              >
                <h2 className={"text-2xl font-bold"}>
                ...
                <p
                  className={
                    "mt-4 text-center text-3xl font-bold text-orange-500"
                  }
                >
                  {newsLetterCount}
                </p>
              ...
              <div
                className={
                  "rounded-xl border-2 border-indigo-500 bg-indigo-50 px-6 py-6 shadow-custom transition-all hover:shadow-customHover"
                }
              >
                <h2 className={"text-2xl font-bold"}>
                ...
                <p
                  className={
                    "mt-4 text-center text-3xl font-bold text-indigo-500"
                  }
                >
                  {newsLetterToday}
                </p>
