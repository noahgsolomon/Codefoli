                ...
                >
                    <div className="lg:max-w-[40%] lg:mb-0 mb-10">
                        ...
                        <p>
                            ...
                            Cognito User Pools, SQS, EC2, DynamoDB, SES Emails, Certificate Manager, Identity and Access Management. In addition,
                ...
                >
                    <div className="lg:max-w-[40%] lg:mb-0 mb-10">
                        ...
                        <p>
                            ...
                            dynamic and interactive experience. TypeScript is employed for static type checking, which significantly
                            improves code reliability and maintainability. For styling, we use Tailwind CSS, a utility-first CSS framework
                            that enables us to create responsive and highly customizable designs efficiently. The entire frontend build
                            process is streamlined with Vite, a next-generation frontend tooling platform that offers features like
                            fast development cycles and optimized production builds. This combination of technologies ensures that users
