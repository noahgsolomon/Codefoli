...
const Origin: FC = () => {
    ...
    return (
        <>
            ...
            <div>
                <h1 className={'font-bold text-center text-6xl mb-20'}>Origin</h1>
                <div className={'transition-all flex flex-col lg:flex-row justify-center mb-10 lg:mx-32 lg:gap-[100px] xl:gap-[200px]'}>
                    <div className={'lg:max-w-[40%]'}>
                        <h2 className={'text-4xl'}>Idea Genesis</h2>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium aliquam aperiam
                            deserunt enim ex facilis, illo ipsum maxime nemo non nulla odit perspiciatis quasi,
                            saepe sed sunt temporibus unde, velit Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium aliquam aperiam
                            deserunt enim ex facilis, illo ipsum maxime nemo non nulla odit perspiciatis quasi,
                            saepe sed sunt temporibus unde, velit Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium aliquam aperiam
                            deserunt enim ex facilis, illo ipsum maxime nemo non nulla odit perspiciatis quasi,
                            saepe sed sunt temporibus unde, velit</p>
                    </div>
                    <div className={'lg:w-[400px] xl:w-[500px]'}>
                        <img className={'w-full rounded-xl border-2 border-black'} src={'./src/assets/codefolilogo.png'} alt={'idea genesis image'}/>
                    </div>
                </div>
                <div className={'transition-all flex flex-col mb-10 lg:flex-row justify-center lg:mx-32 lg:gap-[100px] xl:gap-[200px]'}>
                    <div className={'lg:max-w-[40%]'}>
                    ...
                    <div className={'lg:w-[400px] xl:w-[500px]'}>
                        <img className={'w-full rounded-xl border-2 border-black'} src={currentTheme === DARK_THEME_KEY
                            ? gapFilledDark
                            : gapFilledLight} alt={'idea genesis image'}/>
                    </div>
                </div>
                <div className={'transition-all flex flex-col lg:flex-row justify-center lg:mx-32 lg:gap-[100px] xl:gap-[200px]'}>
                    <div className={'lg:max-w-[40%]'}>
                    ...
                    <div className={'lg:w-[400px] xl:w-[500px]'}>
                        <img className={'w-full rounded-xl border-2 border-black'} src={currentTheme === DARK_THEME_KEY
                            ? journeyDark
                            : journeyLight} alt={'idea genesis image'}/>
                    </div>
                </div>
            </div>
            <Footer />
