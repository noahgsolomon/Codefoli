...
const Card = ({ ImageUrl, title, description }: Props) => {
  return (
    <div className="m-5 mb-5 flex w-96 flex-col items-center space-y-5 rounded-2xl border-2 border-black bg-white dark:bg-[#1a1a1a] p-5 shadow-custom transition-all hover:-translate-y-0.5 hover:shadow-customHover">
      {ImageUrl &&
