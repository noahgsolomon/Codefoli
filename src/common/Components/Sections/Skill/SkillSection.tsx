    ...
    >
      ...
      {headerOneEdit ? (
        <textarea
          ...
          className="p-0 mb-10 w-full resize-none appearance-none overflow-hidden border-none bg-transparent text-center text-2xl font-bold leading-relaxed outline-none focus:outline-none focus:ring-0"
          autoFocus
          onInput={(e) => {
          ...
          >
            ...
            {userData.skills.length < 12 && (
              <span
                ...
                } inline-flex cursor-pointer items-center justify-center rounded-lg bg-gray-300 px-3 text-white transition-all hover:-translate-y-0.5 hover:bg-green-500 hover:text-white`}
