            ...
            {descriptionOneEdit ? (
              <div className={"flex justify-center md:justify-normal"}>
                <textarea
                  ...
                  className="mx-auto w-full max-w-[35ch] resize-none appearance-none overflow-hidden border-none bg-transparent p-0 text-center text-base opacity-60 outline-none focus:outline-none focus:ring-0 md:mx-0 md:text-left xl:max-w-[50ch]"
                  autoFocus
                  onFocus={(e) => {
                    e.target.select();
                  }}
