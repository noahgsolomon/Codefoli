            ...
            <div className="container mb-10 flex flex-col items-center justify-between xl:flex-row">
              <div className="mb-10 flex flex-col items-center justify-center gap-10 xl:items-start">
                <div className="relative flex w-full items-center justify-center gap-4 xl:justify-start">
                  <h1 className="bg-gradient-to-r from-gray-400 to-black bg-clip-text text-6xl font-extrabold leading-[5.5rem] text-transparent dark:to-white sm:text-8xl">
                    Codefoli
                  </h1>
                </div>
                ...
                <div className="flex flex-col gap-3 sm:flex-row">
                  ...
                  >
                    <Link to="/waitlist">
                      <span className="inline-flex h-full w-fit items-center gap-1 rounded-[10px] bg-white px-12 py-2 text-gray-800 opacity-90 transition-all duration-300 md:px-4">
                        Join Waitlist →
                      </span>
                    </Link>
                  </Button>
                  ...
                  >
                    <Link to="/waitlist">
                      <span className="inline-flex h-full w-fit items-center gap-1 rounded-[10px] px-12 py-2 opacity-90 transition-all duration-300 dark:bg-neutral-900 dark:text-white md:px-4">
                        Join Waitlist →
                      </span>
                    </Link>
                  </Button>
