...
const Waitlist = () => {
  ...
  return (
    <div className={"h-screen"}>
      ...
      <main className="relative mt-40 flex items-start justify-center sm:px-16 md:px-0">
              ...
              <section className={"relative overflow-hidden"}>
                {emailAdded ? (
                  ...
                  <div className="flex flex-col items-center justify-center">
                    ...
                    />
                    <Button
                      className="wl-form-button group relative mt-6 w-[250px] w-full overflow-hidden rounded-xl px-[2px] py-[2px] font-bold transition-shadow duration-300 hover:shadow-[0_0.5rem_2rem_-0.75rem_#3178c6] dark:hover:shadow-[0_0.5rem_2rem_-0.75rem_#5198f6]"
