...
const Header: FC<{
  ...
  return (
    ...
    >
      <div className="shadow-custom mx-auto flex w-full max-w-[50rem] flex-row flex-wrap items-center justify-center rounded-xl border-2 border-black px-4 py-3 transition-all dark:bg-[#1a1a1a] sm:justify-between">
        <Link
          to="/home"
