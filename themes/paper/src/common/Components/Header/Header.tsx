      ...
      >
        {blank ? (
          ...
          <>
            <Link
              to="/"
              className="mx-3 py-1 text-2xl text-gray-800 no-underline  transition-all hover:text-blue-500 dark:text-gray-50 dark:hover:text-blue-500"
            >
              Home
            </Link>
            <Link
