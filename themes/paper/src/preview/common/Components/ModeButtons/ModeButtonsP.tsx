              ...
              <div className="flex flex-col justify-center rounded-lg bg-white p-8 shadow-lg dark:bg-[#1a1a1a]">
                ...
                <div className="flex items-center">
                  ...
                  {!subdomainChecking ? (
                    ...
                    <div className="m-2 flex items-center justify-center rounded-xl border-2 border-black bg-black px-4 py-2">
                      <svg
        ...
        >
          <div className="w-1/2 max-w-[400px] rounded-lg bg-white p-6 dark:bg-[#1a1a1a]">
            ...
            {!importedDomainLoading ? (
              ...
              <div className="fixed inset-0 bottom-0 left-0 right-0 top-0 z-50 flex flex-col items-center justify-center bg-gray-600 bg-opacity-50">
        ...
        >
          <div className="rounded-lg bg-white p-6 dark:bg-[#1a1a1a] ">
            ...
            <p className="mb-4 opacity-80">
              Please allow <span className="underline">24 hours</span> for these
              changes to take affect depending on your provider
            </p>
